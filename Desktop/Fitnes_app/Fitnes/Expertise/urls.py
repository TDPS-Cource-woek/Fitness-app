...
urlpatterns = [
    ...
    path('timetables/update/<int:pk>/', expertise.expert_timetable_update, name='timetable_update'),
    path('timetables/delete/<int:pk>/', expertise.expert_timetable_delete, name='timetable_delete'),
